...
class BaseHyperparameters(object):
    def __init__(self):
        ...
        self.MAX_EPISODES = 60000  # 60000 : 500
        self.LEARNING_RATE = 0.0002
        self.INITIAL_EXPLOR = 0  # 0 : 0.5
        self.FINAL_EXPLOR = 0.9
        self.FINAL_EXPLOR_FRAME = 300000  # 300000 : 450
        self.DISCOUNT_FACTOR = 0.99
        self.MINIBATCH_SIZE = 32  # 32 : 8
        self.REPLY_START_SIZE = 50000  # 50000 : 100
        self.REPLY_MEMORY_SIZE = 500000
        self.TARGET_NETWORK_UPDATE_FREQUENCY = 10000  # 10000 : 150

        # log and output
        self.WEIGHTS_SAVER_ITER = 2000  # 2000 : 200
        self.OUTPUT_SAVER_ITER = 2000  # 1000 : 100
